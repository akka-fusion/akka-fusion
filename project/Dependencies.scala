...
object Dependencies {
  ...
  lazy val _akkaStream  = "com.typesafe.akka" %% "akka-stream" % versionAkka
  lazy val _akkaTestkit = "com.typesafe.akka" %% "akka-testkit" % versionAkka
  lazy val _akkaStreamTestkit = "com.typesafe.akka" %% "akka-stream-testkit" % versionAkka
