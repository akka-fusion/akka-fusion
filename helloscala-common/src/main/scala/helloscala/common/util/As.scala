...
object AsBoolean {
  ...
  def str2bool(str: String): Option[Boolean] =
  ...
  def unapply(v: Any): Option[Boolean] =
    v match {
      case null                 => None
...
object AsShort {
  ...
  def unapply(v: Any): Option[Short] =
    v match {
      case null               => None
      case s: Short           => Some(s)
...
object AsFloat {
  ...
  def unapply(v: Any): Option[Float] =
    v match {
      case null               => None
      case f: Float           => Some(f)
...
object AsDouble {
  ...
  def unapply(v: Any): Option[Double] =
    v match {
      case null                => None
...
object AsDate {
  ...
  def unapply(v: AnyRef): Option[Date] =
    v match {
      case null           => None
      case d: Date        => Some(d)
...
object AsSQLDate {
  ...
  def unapply(v: AnyRef): Option[sql.Date] =
    v match {
...
object AsSQLTime {
  ...
  def unapply(v: AnyRef): Option[sql.Time] =
    v match {
...
object AsTimestamp {
  ...
  def unapply(v: AnyRef): Option[Timestamp] =
    v match {
      case null           => None
...
object AsInstant {
  ...
  def unapply(v: AnyRef): Option[Instant] =
    v match {
      case null         => None
...
object AsLocalDate {
  ...
  def unapply(v: AnyRef): Option[LocalDate] =
    v match {
      case null                 => None
...
object AsLocalTime {
  ...
  def unapply(v: AnyRef): Option[LocalTime] =
    v match {
      case null                 => None
...
object AsLocalDateTime {
  ...
  def unapply(v: AnyRef): Option[LocalDateTime] =
    v match {
      case null                 => None
...
object AsZonedDateTime {
  ...
  def unapply(v: Any): Option[ZonedDateTime] =
    v match {
      case null                  => None
...
object AsOffsetDateTime {
  ...
  def unapply(v: Any): Option[OffsetDateTime] =
    v match {
      case null                => None
